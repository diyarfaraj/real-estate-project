      ...
      <div className={classes.wrapper}>
        ...
        <div className={classes.right}>
          ...
          <div className={classes.location}>
            Location: <span>{yacht?.location}</span>
          </div>
          <div className={classes.price}>
            Price: <span>$ {yacht?.price}</span>
          </div>
          <div className={classes.passengers}>
            Max passengers allowed: <span>{yacht?.maxPassengers}</span>
          </div>
          <div className={classes.descContainer}>
            Description: <p>{yacht?.desc}</p>
          </div>
          <div className={classes.metersLong}>
            Meters long: <span>{yacht?.metersLong}</span>
          </div>
